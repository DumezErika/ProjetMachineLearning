...
Euler's method is a one-step method with a constant step $h$. It is similar to a Taylor development (q.v. \ref{reminders}), the idea is to compute $u(t_{i+1})$ using the formula
$$
...
\section{References}
\begin{itemize}
\item  Ricky T. Q. Chen, Yulia Rubanova, Jesse Bettencourt, David Duvenaud \textit{Neural Ordinary Differential Equations}.

\url{https://arxiv.org/pdf/1806.07366.pdf}

\item Zico Kolter, David Duvenaud, and Matt Johnson, \textit{Deep Implicit Layers - Neural ODEs, Deep Equilibirum Models, and Beyond}.

\url{https://implicit-layers-tutorial.org/}



\item  Ayan Das, \textit{Neural Ordinary Differential Equation (Neural ODE)}.

\url{https://ayandas.me/blog-tut/2020/03/20/neural-ode.html}

\item Hanshu Yan, Jiawei Du, Vincent Tan, Jiashi Feng, \textit{On Robustness of Neural Ordinary Differential Equations}.

\url{https://openreview.net/forum?id=B1e9Y2NYvS}

\item Amer Zayegh, Nizar Al Bassam, \textit{Neural Network Principles and Applications}.

\url{https://www.researchgate.net/publication/329264107_Neural_Network_Principles_and_Applications}

\item Neural ODEs Introduction

\url{https://www.youtube.com/watch?v=uPd0B0WhH5w}

\item  Gareth James, Daniela Witten, Trevor Hastie, Robert Tibshirani, \textit{An Introduction to Statistical Learning with Applications in R}. Springer.

\item\textit{Stanford CS229: Machine Learning | Autumn 2018}, Lecture 11, 12, 13.

\url{https://www.youtube.com/playlist?list=PLoROMvodv4rMiGQp3WXShtMGgzqpfVfbU}

\item  Christophe Troestler, \guillemotleft Analyse Numérique \guillemotright, UMONS, 2018-2019
