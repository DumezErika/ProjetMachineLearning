...
\noindent A \textit{neural network} \cite{8} is used to solve a machine learning problem. It consists of a series of layers. There are three types of layers :
